...
ZP_ECS_ENEMY_STATE_TABLE     = $40
ZP_ECS_ENEMY_STATE_TABLE_LSB = ZP_ECS_ENEMY_STATE_TABLE
ZP_ECS_ENEMY_STATE_TABLE_MSB = ZP_ECS_ENEMY_STATE_TABLE + 1

ZP_ECS_ENEMY_STATE_CURRENT   = $42
TS_TESTING   = $43
