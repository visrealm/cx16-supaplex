...
tileInfotronEat:  +tileDef  67, INFOTR_ADDR, 5, INFOTR_PAL, 0
tileInfotronEat2: +tileDef  68, INFOTR_ADDR, 6, INFOTR_PAL, 0
tileInfotronEat3: +tileDef  69, INFOTR_ADDR, 7, INFOTR_PAL, 0
tileInfotronEat4: +tileDef  70, INFOTR_ADDR, 8, INFOTR_PAL, 0
tileInfotronEat5: +tileDef  71, INFOTR_ADDR, 9, INFOTR_PAL, 0
tileInfotronEat6: +tileDef  72, INFOTR_ADDR, 10, INFOTR_PAL, 0
tileInfotronEat7: +tileDef  73, INFOTR_ADDR, 11, INFOTR_PAL, 0
...
tileSnikDown1:    +tileDef 135, SNIKSN_ADDR, 0, SNIKSN_PAL, TILE_FLIP_V
tileSnikDown2:    +tileDef 136, SNIKSN_ADDR, 0, SNIKSN_PAL, TILE_FLIP_V
tileSnikDown3:    +tileDef 137, SNIKSN_ADDR, 0, SNIKSN_PAL, TILE_FLIP_V
tileSnikDown4:    +tileDef 138, SNIKSN_ADDR, 4, SNIKSN_PAL, TILE_FLIP_V
tileSnikDown5:    +tileDef 139, SNIKSN_ADDR, 4, SNIKSN_PAL, TILE_FLIP_V
tileSnikDown6:    +tileDef 140, SNIKSN_ADDR, 5, SNIKSN_PAL, TILE_FLIP_V
tileSnikDown7:    +tileDef 141, SNIKSN_ADDR, 5, SNIKSN_PAL, TILE_FLIP_V
tileSnikDown8:    +tileDef 142, SNIKSN_ADDR, 3, SNIKSN_PAL, TILE_FLIP_V
...
tileSnikLeft2:    +tileDef 184, SNIKSN_ADDR, 6, SNIKSN_PAL, 0
tileSnikLeft3:    +tileDef 185, SNIKSN_ADDR, 7, SNIKSN_PAL, 0
tileSnikLeft4:    +tileDef 186, SNIKSN_ADDR, 8, SNIKSN_PAL, 0
tileSnikLeft5:    +tileDef 187, SNIKSN_ADDR, 8, SNIKSN_PAL, 0
tileSnikLeft6:    +tileDef 188, SNIKSN_ADDR, 7, SNIKSN_PAL, 0
tileSnikLeft7:    +tileDef 189, SNIKSN_ADDR, 6, SNIKSN_PAL, 0
tileSnikLeft8:    +tileDef 190, SNIKSN_ADDR, 2, SNIKSN_PAL, 0
tileSnikRight1:   +tileDef 191, SNIKSN_ADDR, 2, SNIKSN_PAL, TILE_FLIP_H
tileSnikRight2:   +tileDef 192, SNIKSN_ADDR, 6, SNIKSN_PAL, TILE_FLIP_H
tileSnikRight3:   +tileDef 193, SNIKSN_ADDR, 7, SNIKSN_PAL, TILE_FLIP_H
tileSnikRight4:   +tileDef 194, SNIKSN_ADDR, 8, SNIKSN_PAL, TILE_FLIP_H
tileSnikRight5:   +tileDef 195, SNIKSN_ADDR, 8, SNIKSN_PAL, TILE_FLIP_H
tileSnikRight6:   +tileDef 196, SNIKSN_ADDR, 7, SNIKSN_PAL, TILE_FLIP_H
tileSnikRight7:   +tileDef 197, SNIKSN_ADDR, 6, SNIKSN_PAL, TILE_FLIP_H
